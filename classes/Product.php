...
class ProductCore extends ObjectModel
{
	...
	/** @var string Long mode_emploi  -Arthur- */
	public $mode_emploi;
	...
	public static $definition = array(
		...
		'fields' => array(
			...
			'mode_emploi' => 				array('type' => self::TYPE_HTML, 'lang' => true, 'validate' => 'isCleanHtml'),
	...
	*/
		...
		$count = false, $order_by = null, $order_way = null, Context $context = null)
	{
		...
		$sql = new DbQuery();
		$sql->select(
			'p.*, product_shop.*, stock.out_of_stock, IFNULL(stock.quantity, 0) as quantity, pl.`description`, pl.`mode_emploi`, pl.`description_short`, pl.`link_rewrite`, pl.`meta_description`,
	...
	public static function getRandomSpecial($id_lang, $beginning = false, $ending = false, Context $context = null)
	{
		...
		if ($product_reductions)
		{
			...
			if (!$id_product = $result['id_product'])
				return false;
			// -Arthur-
			$sql = 'SELECT p.*, product_shop.*, stock.`out_of_stock` out_of_stock, pl.`description`, pl.`mode_emploi`, pl.`description_short`,
	...
	*/
		...
		$order_by = null, $order_way = null, $beginning = false, $ending = false, Context $context = null)
	{
		...
		//-Arthur-
		$sql = 'SELECT p.*, product_shop.*, stock.out_of_stock, IFNULL(stock.quantity, 0) as quantity, pl.`description`, pl.`mode_emploi`, pl.`description_short`, MAX(product_attribute_shop.id_product_attribute) id_product_attribute,

<?php /* Smarty version Smarty-3.1.14, created on 2014-02-26 15:11:05
         compiled from "C:\wamp\www\LadyMoving\themes\leoclot\products-comparison.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16779530df5f97e6366-53232214%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9a4ad0f5c14e8835df5d711258f4ce3688f98e9b' => 
    array (
      0 => 'C:\\wamp\\www\\LadyMoving\\themes\\leoclot\\products-comparison.tpl',
      1 => 1392888048,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16779530df5f97e6366-53232214',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_530df5f9aa3480_46704836',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_530df5f9aa3480_46704836')) {function content_530df5f9aa3480_46704836($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\LadyMoving\\tools\\smarty\\plugins\\modifier.escape.php';
if (!is_callable('smarty_function_math')) include 'C:\\wamp\\www\\LadyMoving\\tools\\smarty\\plugins\\function.math.php';
if (!is_callable('smarty_function_cycle')) include 'C:\\wamp\\www\\LadyMoving\\tools\\smarty\\plugins\\function.cycle.php';
?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value->name,27,'...'), 'htmlall', 'UTF-8');?>
						...
						<div class="description"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product']->value->description_short),60,'...');?>
</div>
 ...
 <?php echo smartyTranslate(array('s'=>'per %s','sprintf'=>smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->unity, 'htmlall', 'UTF-8')),$_smarty_tpl);?>
					...
					<div class="buttons-action product_bottom">
						<a class="cmp_remove clearfix button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('products-comparison',true), ENT_QUOTES, 'UTF-8', true);?>

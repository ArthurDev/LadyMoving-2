<?php /* Smarty version Smarty-3.1.14, created on 2014-02-20 15:03:26
         compiled from "C:\wamp\www\LadyMoving\modules\leotempcp\views\templates\admin\leotempcp_panel\panel.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1912153060b2e51d7d4-48556398%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '449c35003c93bb8a2fc6ad662acbdab8cdb9ef92' => 
    array (
      0 => 'C:\\wamp\\www\\LadyMoving\\modules\\leotempcp\\views\\templates\\admin\\leotempcp_panel\\panel.tpl',
      1 => 1392888065,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1912153060b2e51d7d4-48556398',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53060b2e9c5543_69452989',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53060b2e9c5543_69452989')) {function content_53060b2e9c5543_69452989($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['showed']->value==true){?>
...
">
				<a class="editmod" title="<?php echo smartyTranslate(array('s'=>'Configure','mod'=>'leotempcp'),$_smarty_tpl);?>
" href="<?php echo $_smarty_tpl->tpl_vars['moduleEditURL']->value;?>
&module_name=<?php echo $_smarty_tpl->tpl_vars['module']->value->name;?>
&configure=<?php echo $_smarty_tpl->tpl_vars['module']->value->name;?>
" data-mod="<?php echo $_smarty_tpl->tpl_vars['module']->value->name;?>
"></a>
...
$(".editmod").fancybox({
 	...
 	afterLoad:function(   ){
 		if( $('body',$('.fancybox-iframe').contents()).find("#main").length  ){  
 			...
 			$('body',$('.fancybox-iframe').contents()).find("#psException").html('<div class="alert error"><?php echo $_smarty_tpl->tpl_vars['noModuleConfig']->value;?>
</div>');
 		}
 	}
});

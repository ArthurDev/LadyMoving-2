<?php /* Smarty version Smarty-3.1.14, created on 2014-02-20 17:38:58
         compiled from "C:\wamp\www\LadyMoving\themes\leoclot\order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:877053062fa2a91669-24091084%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f4997f58c1b21112a475a97522af148c6e32041e' => 
    array (
      0 => 'C:\\wamp\\www\\LadyMoving\\themes\\leoclot\\order-detail.tpl',
      1 => 1392888048,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '877053062fa2a91669-24091084',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_53062fa3406825_84650862',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53062fa3406825_84650862')) {function content_53062fa3406825_84650862($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\LadyMoving\\tools\\smarty\\plugins\\modifier.escape.php';
...
<div class="adresses_bloc row block clearfix">
	<ul class="address item <?php if ($_smarty_tpl->tpl_vars['order']->value->isVirtual()){?>col-sm-12<?php }else{ ?>col-sm-6<?php }?>">
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['invoiceAddressFormatedValues']->value[smarty_modifier_replace($_smarty_tpl->tpl_vars['word_item']->value,',','')], 'htmlall', 'UTF-8');?>
	...
	<ul class="col-sm-6 address alternate_item" <?php if ($_smarty_tpl->tpl_vars['order']->value->isVirtual()){?>style="display:none;"<?php }?>>
...
<?php }?>: <span class="price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0][0]->displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['order']->value->getTotalProductsWithTaxes(),'currency'=>$_smarty_tpl->tpl_vars['currency']->value),$_smarty_tpl);?>
 ...
 <span class="price-discount price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPriceWithCurrency'][0][0]->displayWtPriceWithCurrency(array('price'=>$_smarty_tpl->tpl_vars['order']->value->total_discounts,'currency'=>$_smarty_tpl->tpl_vars['currency']->value,'convert'=>1),$_smarty_tpl);?>
</span>
				</td>
			</tr>
			<?php }?>
...
" method="post" class="std" id="sendOrderMessage">
		...
		<div class="form-group">
			<label class="control-lable" for="id_product"><?php echo smartyTranslate(array('s'=>'Product'),$_smarty_tpl);?>
</label>
		</div>
		<div class="form-group">

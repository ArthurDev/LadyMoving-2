...
class LeoBlogsArticle extends Module
{
	...
	public function displayForm()
	{
		...
		<form action="'.Tools::safeOutput($_SERVER['REQUEST_URI']).'" method="post">
			<fieldset>
				...
				<div class="row-form">
					' . $this->params->selectTag($orders, "Show article by", 'showby', $this->params->get('showby')) . '
	...
	{		 
            if (!$this->isCached('leoblogsarticle.tpl', $this->getCacheId('leoblogsarticle')))
            {
            ...
            return $this->display(__FILE__, 'leoblogsarticle.tpl');
        }

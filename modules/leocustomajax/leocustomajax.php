	...
	public function displayForm()
	{
		return '<form action="'.Tools::safeOutput($_SERVER['REQUEST_URI']).'" method="post">
			<fieldset>
				...
				<div class="margin-form">
					<input type="radio" name="leo_customajax_rt" id="rt_display_on" value="1" '.(Tools::getValue('leo_customajax_rt', Configuration::get('leo_customajax_rt')) ? 'checked="checked" ' : '').'/>
					<label class="t" for="rt_display_on"> <img src="../img/admin/enabled.gif" alt="'.$this->l('Enabled').'" title="'.$this->l('Enabled').'" /></label>
					<input type="radio" name="leo_customajax_rt" id="rt_display_off" value="0" '.(!Tools::getValue('leo_customajax_rt', Configuration::get('leo_customajax_rt')) ? 'checked="checked" ' : '').'/>
					<label class="t" for="rt_display_off"> <img src="../img/admin/disabled.gif" alt="'.$this->l('Disabled').'" title="'.$this->l('Disabled').'" /></label>
					<p class="clear">'.$this->l('You have to make sure that you are using productcomment module of prestashop.').'</p>
						<br/>'.$this->l('You can add this code in tpl file of module you want to show comment:').'
						<br/>
                ...
                <label>'.$this->l('Show Multiple Product Image.').'</label>
				<div class="margin-form">
					<input type="radio" name="leo_customajax_img" id="img_display_on" value="1" '.(Tools::getValue('leo_customajax_img', Configuration::get('leo_customajax_img')) ? 'checked="checked" ' : '').'/>
					<label class="t" for="img_display_on"> <img src="../img/admin/enabled.gif" alt="'.$this->l('Enabled').'" title="'.$this->l('Enabled').'" /></label>
					<input type="radio" name="leo_customajax_img" id="img_display_off" value="0" '.(!Tools::getValue('leo_customajax_img', Configuration::get('leo_customajax_img')) ? 'checked="checked" ' : '').'/>
					<label class="t" for="img_display_off"> <img src="../img/admin/disabled.gif" alt="'.$this->l('Disabled').'" title="'.$this->l('Disabled').'" /></label>
                                        <br/>'.$this->l('You can add this code in tpl file of module you want to show Multiple Product Image:').'
                                        <br/>
                                        <textarea style="width: 772px; height: 111px;">
                                        add this code
				...
				<div class="margin-form">
					...
					<label class="t" for="qv_display_off"> <img src="../img/admin/disabled.gif" alt="'.$this->l('Disabled').'" title="'.$this->l('Disabled').'" /></label>
                                ...
                                <label style="color:red">'.$this->l('NOTE:').'</label>
				<div class="margin-form">
                                        <br/>'.$this->l('If you want my script run fine with blog layer module.').'
                                        <p style="color:red">'.$this->l('Please copy to override file modules/blocklayered/blocklayered.js to folder themes/TEMPLATE_NAME/js/modules/blocklayered/blocklayered.js.').'</p>
                                        <p>'.$this->l('Then find function reloadContent(params_plus) default in line 318.').'</p>
                                        <textarea style="width: 772px; height: 111px;">
                                        -------in function find the code( default in line 497)------
                                            }
                                        });

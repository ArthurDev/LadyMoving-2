...
class LofPsblogsPublication extends ObjectModel {
                ...
                if (move_uploaded_file($_FILES[$name]['tmp_name'], $imageFullPath)) {
                    ...
                    if (file_exists($imageFullPath)) {
                        ...
                        if (!file_exists($thumbFullPath)) {
                            $helper->createThumb($imageFullPath, $thumbFullPath, $this->module_params->get('thumb_width', 126), $this->module_params->get('thumb_height', 126));
                        } else {
    ...
    function uploadGallery($files) {
        ...
        $thumbWidth = $this->module_params->get('thumb_width', 126);
        $thumbHeight = $this->module_params->get('thumb_height', 126);
    ...
    function removeSelectedImages() {
        $images = Tools::getValue('remove_images');
    ...
    function addComment($published = 0) {
        ...
        $fields['content'] = Tools::getValue('content');

...
class lofBlogs extends Module {
    ...
    public function getContent() {
        /*
        Db::getInstance()->Execute('ALTER TABLE `'._DB_PREFIX_.'lofblogs_blocks` CHANGE `id` `id_lofblogs_blocks` INT( 11 ) NOT NULL ;');
        Db::getInstance()->Execute('ALTER TABLE `'._DB_PREFIX_.'lofblogs_blocks_lang` CHANGE `id` `id_lofblogs_blocks` INT( 11 ) NOT NULL ;');
        */

...
<div class="item_comment_form">
    ...
    <form action="" method="post" name="submit_comment" >
        <div class="lofcontent_line">
            <label  for="name">{l s='Your name' mod='lofblogs'}</label> 
        ...
        <div class="lofcontent_line">
            <label for="email">{l s='Your Email' mod='lofblogs'}</label>
            <div class="lofcontent_right_col">
                <input id="cm_email" name="email" type="text" value="{$customer.email}" />
            </div>
        </div>
        <div class="lofcontent_line">
            <label for="website">{l s='Your website' mod='lofblogs'}</label>
            <div class="lofcontent_right_col">
                <input id="cm_website" name="website" type="text" value="" />     
            </div>
        </div>        
        <div class="lofcontent_line">
            <label for="content">{l s='Comment' mod='lofblogs'}</label>
        ...
        <div class="lofcontent_line">
            <label for="website">{l s='Confirm code' mod='lofblogs'}</label>
            <div class="lofcontent_right_col">

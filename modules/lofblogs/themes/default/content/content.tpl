...
<div id="lofcontent_content" class="lofcontent_block">
    ...
    <div class="lofcontent_rating_container" >
        <div id="article_rating_label">{l s='Article Rating' mod='lofblogs'} </div>
...
<div class="lofcontent_content_main">
    <div class="lofcontent_main_content" >
        ...
        <div class="primay_img img_align_{$config.imgAlign}">
            <img {if $config.content_img_width}width="{$config.content_img_width}"{/if} src="{$imageUri}{$LBObject->image}" alt="{$LBObject->title}" />
        </div>
        {/if}
        {$LBObject->content}
    </div>
